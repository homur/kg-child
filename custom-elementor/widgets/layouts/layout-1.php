                    ...
                    <div class="post-grid-text-wrap custom-post-grid-text-wrap d-flex align-items-start flex-column">
                        ...
                        <div class="post-grid-buttons mt-auto">
                            ...
                            <div class="post-grid-share-box">
                                ...
                                <a href="https://twitter.com/intent/tweet?url=<?php echo $this->render_post_link(); ?>&text=<?php echo $this->render_post_title(); ?>" target="_blank">
                                    <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo $this->render_post_link(); ?>&text=<?php echo $this->render_post_title(); ?>" target="_blank">
                                    <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
