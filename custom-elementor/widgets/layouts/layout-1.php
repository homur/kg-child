    ...
    $all_posts->the_post(); ?>
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class('wpcap-post'); ?>>
            ...
            <div class="post-grid-inner" >
                ...
                <?php }?>
                <div class="col-sm-12 <?php if (get_the_post_thumbnail_url($this->ID, 'post-thumbnail')) { echo "col-md-8";} else {echo "col-md-12";}?>">
                <div class="post-grid-text-wrap custom-post-grid-text-wrap d-flex align-items-start flex-column">
	                ...
	                <div class="post-grid-buttons mt-auto">
                        ...
                        <div class="post-grid-share-box">
                            <p>Share</p>
                            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $this->render_post_link(); ?>&t=<?php echo $this->render_post_title(); ?>"
